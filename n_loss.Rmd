---
title: "Modelled N loss by NO~3~ leaching and NH3^+^ volatilization in Iowa from row cropped and switchgrass fields"
author: "Elke Brandes"
...
##Required packages##
```{r packages, message=FALSE, opts_chunk$set(echo=FALSE, message=FALSE, fig.width=6, fig.height=6)}
