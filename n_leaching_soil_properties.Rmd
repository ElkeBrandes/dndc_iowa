...
soil_contrast <- soil_stats[1:2,1:12]
...
```{r barplot, fig.cap = "Figure 13: Nitrate leaching, ammonium volatilization, and soil parameters as weighted averages for soils in Woodbury, Plymouth and Lyon County, leaching < 0.1 kg/ha (low) and soils leaching > 20 kg/ha adjacent the low leaching soils (norm)."}
soil_stats_abs[1:2,] %>%
