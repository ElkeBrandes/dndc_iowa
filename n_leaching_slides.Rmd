...
```{r scatterplot, cache=TRUE, fig.show="hold", fig.width=4, fig.height=3.5, fig.cap="Figure 4: Scatterplot of a subsample (n=10,000) of profitability and corn/soy NO~3~^-^ leaching data on subfield areas in Iowa."}
ggplot() +
