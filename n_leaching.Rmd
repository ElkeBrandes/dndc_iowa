...
```{r profit_distribution, warning = FALSE, fig.cap="Figure 1: Distribution of mean profitability 2012-2015. The vertical line marks the -150 US$/ha cut off value used in the profit opimization (PO) scenario for switchgrass integration below."}
...
n_loss_red <- data.frame(status_quo = 0,
...
Then I plot the state-wide relative N loss reduction from the status quo to switchgrass integration, as a function of the area converted to switchgrass, and as a function of the profitability threshold applied.
