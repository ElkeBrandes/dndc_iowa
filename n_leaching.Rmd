...
```
With RPostgreSQL:
```{r, connect_rpostgres, message=FALSE, cache=TRUE}
...
ggplot(profit, aes(profit_mean_ha_rounded, weight = sum_ha)) + 
  ...
  scale_x_continuous(name="Mean profitability 2012-2015 (US$/ha)") +
  scale_y_continuous(name="Area (Mha)") +
  geom_vline(aes(xintercept= -500, linetype= "dashed"),  show.legend = FALSE) +
  geom_vline(aes(xintercept= -350, linetype= "dashed"),  show.legend = FALSE) +
  ...
  geom_vline(aes(xintercept= -50, linetype= "dashed"),  show.legend = FALSE) +
