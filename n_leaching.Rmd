...
```{r profit_spatial, fig.cap="Figure 2: Areas below a profitability of -150 US$/ha per county. "}
...
ggplot() +
  ...
  labs(size = "Total area below -150 US$/ha (ha)") +
  coord_equal() +
  ditch_the_axes +
  labs(fill = "Relative area below -150 US$/ha (%)") +
