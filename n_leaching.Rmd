...
##3. Correlation between profitability and NO3 leaching in corn and soybean fields##
...
```{r scatter_ph, fig.show = "hold", fig.cap="Figure 7: Scatterplot of a subsample (n=10,000) of pH values on subfield areas in Iowa."}
ggplot() +
