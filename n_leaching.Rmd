...
# join the attributes back to the data frame:
counties_df <- left_join(counties_df, counties@data)
```
...
ggplot(counties_df) +
  geom_polygon(aes(long, lat, group = group, fill=ave_no3_leach_cgsb), color = "white") +
  coord_equal() +
  ditch_the_axes
