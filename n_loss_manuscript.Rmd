...
theme_gcbb <- function (base_size = 11, base_family = "") 
{
  theme_grey(base_size = base_size, base_family = base_family) %+replace% 
    theme(
...
plot_profit <- ggplot(data = profit, aes(profit_ha_rounded, weight = area_Mha)) +
  ...
  scale_y_continuous() +
  annotate("text", x = -970, y = .4, label = "(a)", size = 4) +
...
plot_leach <- ggplot(cgsb_no3_leach, aes(ave_no3_leach_cgsb_round, weight = area_Mha)) +
  ...
  scale_y_continuous() +
  annotate("text", x = 3.5, y = .52, label = "(b)", size = 4) +
...
png('fig3.tiff', width = 169, height = 80, units = "mm", res = 300)
...
png('fig4.tiff', width = 169, height = 100, units = "mm", res = 300)
...
png('fig5.tiff', width = 80, height = 70, units = "mm", res = 300)
...
png('fig5.tiff', width = 250, height = 250, units = "mm", res = 300)
...
png('fig7.tiff', width = 169, height = 100, units = "mm", res = 300)
...
png('fig8.tiff', width = 169, height = 100, units = "mm", res = 300)
...
png('figS1.tiff', width = 169, height = 169, units = "mm", res = 300)
...
png('figS3.tiff', width = 169, height = 100, units = "mm", res = 300)
...
png('figS4.tiff', width = 169, height = 169, units = "mm", res = 300)
...
png('figS5.tiff', width = 120, height = 70, units = "mm", res = 300)
...
#  scale_color_discrete(name="Switchgrass\nYield (kg/ha)",  guide = FALSE) +
  annotate("text", x = 2, y = 42, label = "(a)", size = 5) +
...
#  scale_color_discrete(name="Switchgrass\nYield (kg/ha)") +
  ...
  annotate("text", x = -460, y = 42, label = "(b)", size = 5) +
    scale_colour_manual(name="Switchgrass\nYield (kg/ha)", values=cbPalette)

png('figS6.tiff', width = 169, height = 80, units = "mm", res = 300)
