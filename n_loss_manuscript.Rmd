...
title: Addressing farm economy, water quality, and bioenergy feedstock production
  by targeted subfield switchgrass integration
author: ""
date: ""
output:
  word_document:
...
Precision agriculture, precision conservation, DeNitrification-DeComposition (DNDC),

## Abstract


Progress on reducing nutrient leaching from Iowa cropland has been slow due to perceived conflicts between short-term profitability and long-term stewardship. Besides mitigating nitrate leaching from cropland, perennial biomass crops such as switchgrass can improve short- and long-term farm profitability and help meet national bioenergy targets. We present a framework that disaggregates previous nitrogen balance estimates down to a finer resolution and takes into account the biogeochemical processes driving nitrogen loss in agroecosystems. To evaluate the potential for switchgrass integration into Iowa's agricultural landscape, we combined data sets from two subfield-scale analyses: (i) a cropland profitability analysis and (ii) an analysis of nitrate leaching from cropland. All data came from public sources and were analyzed using peer-reviewed, public models. For each subfield unit, we based the management change decision from row crops to switchgrass on baseline (2012-2015) profitability and nitrate leaching rates, creating a matrix of possible threshold combinations. For each resulting scenario we calculated percent of Iowa cropland in switchgrass, resulting biomass production, and relative reduction in nitrate leaching compared to the baseline. We present spatially explicit leaching reduction for a conservative scenario and a nutrient reduction scenario that resulted in 12% and 35% of cropland converted to switchgrass, 11 and 33 million metric tonnes of biomass produced from switchgrass, and 18 % and 38 % reduction in nitrate leaching, respectively, for Iowa. Within the impaired Upper North Raccoon River Watershed, both scenarios showed slightly lower reduction in nitrate leaching that the state-wide average. Most converted subfield areas displayed high nitrate leaching reduction (> 50 %), but the high productivity of most cropland in this watershed resulted in a relatively small conversion area and therefore a low mean nitrate leaching reduction. Though approximated, our analysis can be turned into a farm-level decision making tool to identify locations where combined goals for farm profitability and water quality improvement can be achieved through the strategic integration of perennial vegetation.
...
- We modeled the leachable N fraction for agricultural lands in the state of Iowa
...
Non-point nutrient pollution from industrialized agriculture in the Mississippi River Basin has been exacerbating the ~ 15,000 km^2^ hypoxic zone in the Gulf of Mexico [@turner2003linking]. Over half of the nitrogen delivered through this route originate from cropland cultivated with maize and soybeans. Iowa, being the second largest contributor [@alexander2008differences], plays a prominent role in efforts to decrease the hypoxic zone's 5 year average to under 5000 km^2^ [@river2008action]. Since this goal was missed in 2015, it has been moved to 2035 by the Hypoxia Task Force [-@htf2015report]. As another downstream effect, nitrate concentrations in drinking water pose a health threat to humans. In Iowa, the North Raccoon River Watershed has gained scientific and public attention, as it provides drinking water for the state's capital and is covered to 80 % with maize and soybeans [@jones2011agricultural].  Agriculture, the most important industry in Iowa’s economy, generated 10% of U.S. maize exports at a value of 1.2 billion US$ in 2016 [@uscensus2016exports]. In addition to the often criticized practice of risking environmental quality for economic gain, the highly productive maize growing cropland in Iowa has been unprofitable on average in recent years [@hart2015planting].


To reduce nitrate-nitrogen (N) in Iowa's surface waters by 41%, the @inrs2013 recommends a wide range of nitrogen conservation practices, but does not account for spatial scales relevant for decision making. Converting annual cropland portions to perennial vegetation is part of this catalogue of practices. In contrast to annual crops, perennial plants tighten the nitrogen cycle by recycling nitrogen from senescing biomass and by taking up soil nutrients more efficiently through highly developed root systems. Efforts have been made recently to develop landscape designs that meet agricultural needs while optimizing environmental risk mitigation by targeted placement of conservation management practices [@mcconnell2011precision]. This approach can potentially be adapted by including perennial crops for sustainable cellulosic bioenergy production [@chaubey2016precision]. Due to their multiple benefits on water and soil quality, perennial biomass crops have been considered suitable for conservation purposes while providing feedstock for a growing bioeconomy [@tilman2009beneficial; @langholtz2016billion]. In fact, perennial crops such as giant miscanthus (*Miscanthus x giganteus*), switchgrass (*Panicum virgatum*), or diverse prairie species mixes resulted in leaching reductions of more than 90% compared to maize-soybean rotations when planted on fertile soils  [@mcisaac2010miscanthus; @smith2013reduced; @daigh2015subsurface]. However, large uncertainties exist on how perennials compare to row crops on less productive cropland, where they would be most likely grown to provide feedstock to an emerging bioeconomy.

Despite these well-known advantages, large extents of perennial grassland have been converted back to cropland in the past decade [@morefield2016grasslands; @lark2015cropland]. In practice, perceived socio-economic barriers prevent the implementation of urgently needed conservation management [@james2010profitability]. Still, there are indications of synergies between economic and environmental risk mitigation: within a single corn field, @ssegane2015multifunctional showed that areas of low crop yield coincided with high nitrate leaching due to low soil fertility related to high water infiltration. This and other research has highlighted the importance to consider within-field variability in management practices to optimize economic efficiency and environmental metrics [@muth2014profitability; @kyveryga2011late; @delgado2008advances]. @asbjornsen2014targeting suggested that strategically targeted placement of perennial crops or land cover can enhance ecological and socio-economic benefits from landscape disproportionately to the area they occupy. However, there is a lack of studies that identify these target areas and quantify ecosystem service outcomes beyond the local scale.

Studies to evaluate the environmental effects of integrated perennial bioenergy crops into US farmland have been conducted at the regional and national scale. Currently the US diverts approximately 40 % of annual maize production to produce ethanol. @vanloocke2016din found that replacing 40 % of the land where maize is currently grown with cellulosic biomass crops in the Mississippi and Atchafalaya River Basin could reduce dissolved inorganic nitrogen (DIN) export to the Gulf of Mexico by 15 to 20 %. Simulating nitrate leaching for scenarios in which 30 % of current maize fields are converted to second generation biofuel feedstocks, @davis2012impact found nitrate leaching reduction of 15 to 22 % in the US Midwest region. Both studies provide high-level indications for water quality improvement, but were conducted on a scale too coarse to reflect farming units relevant for decision making. @vanloocke2016din suggest that integration of perennial grasses targeted to areas of low row crop productivity and high leaching rates could further increase surface water quality. However, this requires a modelling framework that includes spatial agronomic information and biochemistry processes at a finer resolution.

Switchgrass, a dominant species of native North American prairies, has been identified as a suitable bioenergy feedstock for the US bioeconomy [@mclaughlin2005development]. The recently registered variety "Liberty" combines optimal traits, such as high productivity and winter hardiness, to be grown in the US Midwest [@vogel2014registration]. We argue that targeted replacement of row crops with "Liberty" switchgrass on low-performing cropland areas can contribute to a reduction of nitrate loss in Iowa. In addition to bioenergy feedstock production, this landscape scale management practice would enhance additional regulating ecosystem services, such as erosion control and carbon sequestration. Building on a recent profitability study that created a case for an economically motivated management change on unprofitable subfield areas in Iowa [@brandes2016subfield], we investigate how the integration of a dedicated bioenergy crop can diversify the agricultural landscape and enhance ecosystem services from a highly simplified agroecosystem. We present a novel approach to precision conservation and perennial integration that places switchgrass on cropland that is least socially desirable for growing row crops, using a three-way comparison:
   
- Baseline scenario: including all cropland continuously in maize and/or soybean between 2012 and 2015

- Conservative scenario: aiming at profit loss and nitrate leaching mitigation by targeting cropland areas with substantial opportunity for improvement

- Nutrient reduction scenario: aiming at the Iowa nutrient reduction goal (41%) through dedicated biomass production

With these scenarios, we identify areas in Iowa with highest potential for switchgrass integration and elucidate the extent and limitations of nitrate leaching reduction by management changes compatible with socio-economic constraints. We focus on the Upper North Raccoon River Watershed as an example impaired watershed to assess potential mitigation efforts and their effectiveness. Our scenarios represent three points along a broad spectrum of possible schemes for the strategic integration of perennials in landscapes dominated by annual crops.

## Methods

Using publicly available data, we calculated subfield level profitability and estimated nitrate leaching with the processed-based DeNitrification-DeComposition model [DNDC; @li1992model] for the baseline, including all cropland that was continuously in maize and/or soybeans 2012-2015, and three switchgrass scenarios of varying biomass yields. We tested the sensitivity of three model outcomes for Iowa (% area in switchgrass, total biomass production, and relative nitrate leaching reduction) to the management change decision points for nitrate leaching and profitability.

### Spatial data

We included all Iowa cropland that was managed in either maize or soybeans consecutively between 2012 and 2015. Subfield units were created by intersecting the latest available common land use (CLU) boundaries [@usda2008clu] with the National Soil Survey map unit delineations [@nrcs2016soil]. Crop cover for each year was identified for each CLU polygon from the respective cropland data layer (CDL) raster files [@nass2016cdl] as described in @gelder2008automated.

### Economic analysis

We performed a profitability analysis on a sub-field resolution following the methods in @brandes2016subfield, but updated the considered time frame to 2012-2015. For each sub-field polygon, defined by field boundaries (CLU) and soil characteristics (Soil Survey), we estimated the profitability, taking into account the management type (maize following maize, maize following soybeans, and soybeans following maize), the respective crop production costs, cash rents, yields, and grain prices for each year.
...
To estimate the potential of nitrate leaching reduction by switchgrass integration at a spatial resolution relevant for decision makers, we applied the  DeNitrification-DeComposition (DNDC) model that accounts for weather and soil dependent processes of the nitrogen cycle to a subfield data set of Iowa. DNDC is a process-based, field-scale biogeochemistry model for agricultural systems that estimates the mass balances of nitrogen and carbon on a daily resolution. Processes are simulated in the six sub-models soil climate, plant growth, decomposition, denitrification, nitrification, and fermentation. The main driving inputs into the model are climate, soil, vegetation, and management practices. An overview of the model is described in @tonitto2010application. We used crop yields as input data, while modeled yields served as a control. Since the study focuses on water quality, we extracted the model results of nitrate leaching and ammonia volatilization, an output closely connected to leaching through the pH-dependent balance between soil-water dissolved ammonium and gaseous ammonia, and the microbial process of nitrification. DNDC had been previously parameterized and calibrated for switchgrass using yield data from a field site at Urbana, Illinois [@gopalakrishnan2012modeling] and evaluated against leaching data on a row crop field in Iowa [@li2006modeling]. We performed four model runs for Iowa cropland. The first run modeled the baseline conditions in Iowa and included all fields consecutively managed for maize and/or soybeans between 2012 and 2015. This data set referred to the same spatial layer as the profitability analysis described above. We also modeled the nutrient mass balance for switchgrass on the same area, assuming low (7,500 kg ha^-1^), medium (10,000 kg ha^-1^), and high (12,500 kg ha^-1^) switchgrass yields. 

```{r framework_figure, fig.cap="Figure 1: Schematic overview of the computational framework used to produce subfield profitability and biogeochemistry maps for Iowa."}
...
kable(manage, digits = 2, col.names=c("Cropping System", "N applied (kg ha^-1^)","Date", "Activity"), align = c('l', 'c', 'l', 'l'), caption="Table 1: Management data used in the DNDC model." )
...
kable(para, digits = 2, col.names=c(" ", "Maize", "Soybeans", "Switchgrass"), align = c('l', 'l', 'l', 'l'), caption="Table 2: Data and parameters used in the DNDC model.")

```


### State-wide switchgrass integration scenarios
In the management decision framework presented in this study, sub-field areas that are most economically and environmentally unfavorable in the baseline scenario are targeted for switchgrass integration. We first examined the state-wide model outcomes for (i) relative cropland area converted to switchgrass, (ii) biomass production from switchgrass, and (iii) relative nitrate leaching reduction, as a function of both profitability and nitrate leaching cut-off decision points. Since the state-wide model outcomes showed a low sensitivity to switchgrass yield (figure S5), we performed further analysis with the medium switchgrass yield of 10,000 kg ha^-1^. We constructed scenarios using a factorial design of profitability and nitrate leaching cut-offs at a state level, covering the range of 2012-2015 mean profitability (US\$-800 ha^-1^ to US\$ 700 ha^-1^, by steps of US\$ 100 ha^-1^) as well as the range of 2012-2015 mean nitrate leaching (0 - 150 kg ha^-1^, by steps of 10 kg ha^-1^), resulting in 256 (16 x 16) distinct scenarios. To visualize the state-wide outcomes for each scenario, we displayed them as a surface in a two-dimensional decision matrix of the two factors. 

### Closer look at select scenarios
From these scenarios, we selected two cases based on their state-wide outcomes to analyze in further detail. The conservative scenario converted all cropland with profitability of < US\$ -100 ha^-1^ and nitrate leaching of > 50 kg N ha^-1^. This scenario was driven by the goal to convert only land of high economic and environmental risk and therefore a substantial opportunty for improvement (i.e., cut-offs are above the median of the state wide profitability and nitrate leaching distributions). The nutrient reduction scenario converted all unprofitable cropland (with profitability of < US\$ 0 ha^-1^) that lost > 20 kg N ha^-1^ through nitrate leaching. This scenario was driven by the goal to reach a substantial portion of the nitrate leaching reduction goal (41\%) set in the Iowa Nutrient Reduction Strategy. For these two scenarios, we compared leaching results to the baseline on a county resolution to identify counties with high potential for water quality improvement. We also studied the impaired upper part of the North Raccoon River Watershed to relate opportunities for water quality improvement with perennial integration to the rest of Iowa.

## Results

### Profitability and nitrate leaching of the baseline scenario

Mean profitability 2012-2015 ranged from US\$ -478 ha^-1^ to US\$ 385 ha^-1^ on 95 % of cropland (disregarding the lowest and highest 2.5 %, respectively) with a median of US$ 53 ha^-1^. 23 % of cropland was losing > US\$ 100 ha^-1^ (figure 2 (a)). Aggregating these areas that we refer to as highly unprofitable cropland, to the county level revealed spatial heterogeneity in its relative and absolute extent across Iowa. The highest total highly unprofitable area  was found in west and central Iowa and highest relative area in the west, central and south part of the state (figure 3). Nitrate leaching ranged from 9 to 113 kg N ha^-1^, when disregarding the 2.5 % of lowest and highest leaching cropland, respectively, with a median of 42 kg N ha^-1^ (figure 2 (b)). The spatial pattern of nitrate leaching in Iowa shows highest leaching in the counties on the Des Moines Lobe Landform (figure S6) and in the north east of the state (figure 4). The relationship between mean profitability and mean nitrate leaching is characterized by an increased variability in leaching with decreasing profitability (figure 5).
...
```{r profit_distribution, fig.width=8, fig.height=3, fig.cap="Figure 2: Distributions of mean profitability (a) and mean nitrate leaching (b) on cropland managed in maize and soybeans 2012-2015. The solid line in panel (a) marks the US$ -100  ha^-1^  cut-off value used in the conservative scenario. The dashed lines mark the lowest and highest 2.5 % of values. "}
...
plot_leach <- plot_leach <- ggplot(cgsb_no3_leach, aes(ave_no3_leach_cgsb_round, weight = area_Mha)) +
  ...
  theme_b_border() +
  labs(x=expression(Mean~nitrate~leaching~(kg~N~ha^{-1}~yr^{-1})),
       y=expression(Area~(Mha))) +
...
```{r figure_profit, fig.height=4, fig.width=9,  fig.cap="Figure 3: Areas below a mean 2012-2015 profitability of US$ -100 ha^-1^ per county in the baseline scenario. Purple shades indicate the relative area, orange circles show the absolute size of the area per county."}
ggplot() +
  ...
  labs(size = expression(Total~area~losing~">100"~"US$"~ha^{-1}~yr^{-1})) +
  coord_equal() +
  ditch_the_axes +
  labs(fill = expression(Relative~area~losing~">100"~"US$"~ha^{-1}~yr^{-1}~("%"))) +
...
```{r plot_n_loss_map, cache = TRUE, fig.width=8, fig.height=4, fig.cap = "Figure 4: Mean (green shades) and total (yellow circles) annual nitrate leaching per county, averaged over 2012-2015 for the baseline scenario."}
...
ggplot(counties_swg_med_df) +
  ...
  labs(fill = expression(atop("Average nitrate", paste("leaching (kg N ha"^{-1}~yr^{-1},")")))) +  
  geom_point(aes(V1, V2, size = tot_no3_leach), color = "yellow") +
  labs(size = expression(Total~leached~nitrate~(Mg~N~yr^{-1}))) +
...
```{r scatterplot_no3_leach, fig.width=4.5, fig.height=3, fig.cap="Figure 5: Scatterplot of a subsample (n=10,000) of subfield areas, showing profitability and nitrate (NO~3~^-^) leaching of the baseline scenario (mean values for maize and soybean fields 2012-2015) in Iowa. The red lines and shaded areas indicate the cut off values for the conservative scenario (solid lines and deap red shade, US$ -100 ha^-1^ for profitability and 50 kg N ha^-1^ for nitrate leaching) and for the nutrient reduction scenario (dashedd lines and light red shade,  US$ 0 ha^-1^ for profitability and 20 kg N ha^-1^ for nitrate leaching)."}
ggplot() +
...
In total, state-wide mean annual nitrogen loss by leaching from farmland in maize/soybeans between 2012 and 2015 amounted to 0.44 million metric tonnes. On the state-wide average, converting all areas losing > US$ 100 ha^-1^ and > 50 kg N ha^-1^ through leaching to switchgrass would result in a 17.3, 18.1, and 18.6 % reduction of nitrate leaching for the low, medium, and high yielding scenario, respectively (table 3). Because of the low sensitivity of model outcomes to switchgrass yield (table 3, figure S5), we conducted further analysis on the medium yield data set only.
...
no3_table <- data.frame(swg_yield = c(7500, 10000, 12500),
                          no3_leach_tot_cons, no3_leach_tot_nutred, no3_red_cons, no3_red_nutred)


kable(no3_table, digits = 1, format.args = list(big.mark = ','), col.names=c("Switchgrass yield (Mg ha^-1^)", "CONS abs. leaching (Mg)","NUT RED abs. leaching (Mg)", "CONS rel. leaching red. (%)", "NUT RED rel. leaching red. (%)"), caption="Table 3: Average annual nitrate leaching in metric tonnes (Mg) nitrogen and nitrate leaching reduction relative to the baseline (%) in Iowa modelled with DNDC. Results are shown for the conservative (CONS) and nutrient reduction (NUT RED) scenario under three different switchgrass yield assumptions (7,500, 10,000, and 12,500 kg ha^-1^)." )

```

11.5 % of total Iowa cropland lost on average > US$ 100 and > 50 kg N through nitrate leaching per hectare and year. This cropland was converted to switchgrass in the conservative scenario. Moving the decision cut-offs toward higher profitability and lower leaching values (i.e., targeting increasingly favorable cropland for conversion to switchgrass) resulted in successively higher area in switchgrass, biomass production from switchgrass, and state-wide nitrate leaching reduction (figures 6, 7). The contour plots (figure 7) serve as a tool to look up a model outcome value visualized as the "elevation" for the corresponding cut-off for profitability and nitrate leaching. The conservative scenario resulted 10.7 million metric tonnes biomass and 18.1 % reduction in nitrate leaching. The nutrient reduction scenario converted cropland of mean profitability < US\$ 0 ha^-1^ and nitrate leaching > 20 kg ha^-1^, resulting in 35.0 % in switchgrass, 32.8 million metric tonnes biomass, and 37.9 % nitrate leaching reduction (dashed and solid lines in figure 7, all scenario results in tables S1-S3).
...
```{r area_surfaceplot, cache = TRUE, fig.height=9, fig.width=10,  fig.cap="Figure 6: State-wide aggregated model outputs for (a) area converted to switchgrass, (b) biomass production, assuming a 10,000 kg ha^-1^ yield, and (c) nitrate leaching reduction as a function of profitability and nitrate leaching driven management decisions. Each corner in the surface grid represents an output value under a given combination of nitrate leaching threshold (the value in kg N ha^-1^ above which the area would be converted to switchgrass) and profitability threshold (the value in US$ ha^-1^ below which the area would be converted to switchgrass)."}
...
persp3D(x, y, z_bm, colvar = z_bm, phi = 10, theta = -150, col = brewer.pal(8,"YlOrBr"), 
        border = 17, facets = TRUE, colkey = TRUE, resfac = 1, clab = "Biomass production \n(million metric tonnes)", 
        lighting = list(alpha = 1),
        xlab = "Profit threshold", ylab = "N loss threshold", zlab = "Biomass (million tonnes)",
        ticktype = "detailed")
...
Our results suggest that highest nitrate leaching reduction with the conservative switchgrass integration scenario can be achieved in some of the central and eastern counties (figure 8). The counties of highest nitrate leaching in the baseline scenario do not necessarily line up with those of highest reduction potential.



```{r plot_n_loss_reduction_map, cache = TRUE, fig.width=8, fig.height=4, fig.cap= "Figure 8: Relative nitrogen leaching reduction per county when switchgrass is grown on areas that loose > US$ 100 ha^-1^ and > 50 kg N ha^-1^, assuming medium (10,000 kg ha^-1^) switchgrass yield, as compared to the status quo in Figure 4."}
ggplot(counties_swg_med_df) +
...
The subfield resolution maps of nitrate leaching reduction (figure 9) illustrate the spatial heterogeneity of the environmental outcomes of the biomass crop integration scenarios. In the conservative scenario, the areas in switchgrass are not evenly distributed across Iowa but clustered along the Raccoon, upper South Skunk, and Cedar Watersheds (figure 9(a)). The nutrient reduction scenario would require much more cropland to be converted to switchgrass, but some regions in the north west and south east would not see significant management changes (figure 9(b)).

Focusing on the Upper North Raccoon River Watershed as an example of an impaired watershed reveals a varying pattern of switchgrass fields (figure 9(c), (d)). In some regions, whole fields are converted while in others, subfield areas are patchy and more fragmented. In the selected portion of the watershed, a region of high (80%) row crop percentage, the conservative scenario (converting cropland that loses > US$ 100 and > 50 kg N ha^-1^ to switchgrass) would result in 14.3 % in switchgrass and a nitrate leaching reduction of 11.3 % (figure 9(c)). Most subfield areas converted to switchgrass display nitrate leaching reduction of over 50 %, but the relative small conversion area (due to relatively high row crop profitability in this watershed) results in a low mean nitrate leaching reduction. The nutrient reduction scenario (converting all unprofitable land that is leaching > 20 kg N ha^-1^ to switchgrass) would result in 39.7 % of row crops converted to switchgrass and a nitrate leaching reduction of 31.4 % (figure 9(d)).

```{r subfield_n_red_iowa_zoom, cache = TRUE, fig.height=5, fig.width=5, fig.cap="Figure 9: Subfield-scale nitrate leaching reduction relative to the balseline scenario in Iowa (a, b) and in the northern part of the North Raccoon River Watershed, spanning across Buena Vista, Pocahontas, Sac, and Calhoun County (c, d). (a) and (c) show the conservative scenario where switchgrass is grown on areas that loose > US$ 100 ha^-1^ and leach > 50 kg N ha^-1^. (b) and (d) show the nutrient reduction scenario where switchgrass is grown on unprofitable areas that leach > 20 kg N ha^-1^."}
...
The results presented here indicate that substantial nutrient leaching reduction can be achieved by targeting least performing cropland to integrate a high-yielding perennial crop. We found that placing the most economically and environmentally unfavourable 11.5 % of cropland into switchgrass would result in a slightly disproportionate water quality improvement for Iowa (i.e., 18.1 % reduction in nitrate leaching). However, this management practice alone is insufficient to reach the Iowa Nutrient Reduction Strategy's goal of 41 % reduction in nitrate loading to surface waters, unless much larger portions of cropland were to be converted.

Our predictions for reductions in nitrate leaching are consistent with field measurements and other modeling studies. As part of a high level nutrient budget for Iowa, @christianson2012nitrogen estimated nitrate leaching from fertilizer inputs as 36 and 24 kg N ha^-1^ for continuous maize and maize after soybeans, respectively. Their approach did not take into account weather and soil related variability, but their results lie within our modeled distribution (figure 2 (b)). Total annual average nitrate leaching per county (Figure 3) is comparable with values for maize cropland in Iowa modeled by @davis2012impact, who found most counties in the northern half of the state losing more than 3200 Mg nitrogen. In comparison to a maize-maize-soybean rotation, miscanthus, switchgrass, and prairie reduced nitrate leaching at 50 cm soil depth by more than 90 % in the forth year of an experiment on deep loess soils in Illinois [@smith2013reduced]. @mcisaac2010miscanthus showed a 97 % reduction in nitrate leaching at 50 cm soil depth in established miscanthus and switchgrass plots compared to maize-soybean rotation on similar soils.  @daigh2015subsurface showed that fertilized, reconstructed prairie lost 89-99 % less nitrate nitrogen to tile drainage water compared to row crops on fertile soils in central Iowa. These reduction rates are at the high end of our modeled nitrate leaching reduction distributions (figure S4). The wider distributions expanding to lower reduction rates across Iowa are realistic, since our results are averaged over a 10 year growing horizon for switchgrass, and span over a variety of soil characteristics and weather conditions. The annual variability in nitrate leaching due to weather conditions has been observed elsewhere [@sprague2011nitrate]. @hatfield2009nitrate found that annual nitrate leaching variations are related to precipitation of the first five months of a year. Projected increases in extreme rain events associated with climate change [@easterling2000observed] are likely to exacerbate nutrient loss through leaching and erosion, reinforcing the need of conservation practices that address multiple environmental risks. The integration of perennial vegetation meets this need by enhancing nutrient uptake and erosion control, while delivering additional ecosystem services such as carbon sequestration, soil production, and biodiversity. 

According to our model, integration of switchgrass on approximately 10 % of cropland would have a stronger effect on nitrate nitrogen loss reduction compared to nutrient management practices, such as changing from continuous maize to a maize-soybean crop rotation [@wu2004decisions] or moving fall fertilization to the spring [@randall2003nitrate]. While planting cover crops might pose less of a barrier to farming decisions, their nutrient reduction efficiency is variable, particularly in the Midwest Maize Belt due to cold winters, and often accompanied by maize yield reductions [@dabney2010using]. Applying less fertilizer can reduce nitrate leaching [@jaynes2001nitrate], but also lead to unintended consequences. @poffenbarger2017maximum have recently shown that nitrogen additions below the agronomic optimum rate can cause long term losses in soil organic carbon in row crop systems. Recognition that nitrate leaching is not the consequence of excess fertilization alone, but rather caused by a combination of cropping system and farming practices [e.g., drainage, tillage, annual crop selection, @jaynes2001nitrate], supports our rationale of an integrated management change at the landscape scale that allows and may even enhance row crop production on appropriate farmland while reducing economic and environmental risk on unsuitable areas.

To reach the Iowa Nutrient Reduction Strategy's goal of 41 % N leaching reduction through perennial integration alone, 40-50 % of Iowa cropland would have to be converted to switchgrass. Our results indicate the need to combine multiple conservation practices and to adapt them to local biophysical and socio-economic conditions. Due to the combination of socio-economic and environmental goals, the resulting state-wide variability in leaching reduction potential is driven by (i) the extent of land converted to switchgrass based on farm-level financial considerations (i.e., threshold of tolerable profit loss) and decisions related to land stewardship (i.e., nitrate leaching threshold), and (ii) the resulting leaching reduction on these areas, based on soil characteristics and baseline crop yields. Our approach to address socio-economic concerns to identify conservation opportunities is supported by results of a recent survey among farmers in Iowa [@arbuckle2015frlp] in which a majority of farmers were willing to improve conservation management to reach the Iowa Nutrient Reduction Strategy's goals, but large uncertainties existed about the economic risks associated with a management change. An economic assessment is beyond the scope of the study presented here, but planned for subsequent publications. 

Our focus on the Upper North Raccoon River Watershed highlights a relevant issue of nutrient leaching concerning the local scale: Its basin provides municipal drinking water for over 500,000 Iowa residents and its area is dominated by intensively managed agriculture. The state capital's utility, the Des Moines Water Works, recently filed a lawsuit against drainage districts of three upstream counties, claiming the need for regulation of tile drainage discharge as a "point source" of nitrate pollution. The lawsuit was dismissed by the supreme court early this year, but the topic remains highly controversal in terms of responsibilities and regulatory requirements to protect public health.

2.4 % of cropland resulted in very low leaching values that coinsided with ammonia volatilization rates above the state wide average (figure 2 (b)). These areas were clustered in the three western counties Sioux, Plymouth, and Woodbury (figure S2). High volatilization occurs at a combination of warm temperatures, sufficient soil moisture and high soil pH. *(add explanation)*

Due to the large geographic area covered, our underlying data includes an approximated yet realistic reflection of reality. Applied to smaller management units and fed with more detailed and accurate data, our spatial results could be used as indicators to identify nonlinear (disproportionate) responses of nitrogen loss reduction to conversion of land to perennial grasses in order to find "sweet spots" where large improvements can be obtained by conversion of small portions of cropland [@qiu2015landscape].

Our methodological setup is not intended to estimate total nitrate fluxes leaving Iowa's geographic area through surface waters. DNDC models leaching at a soil depth of 50 cm and does not account for further reduction in nitrate concentration observed in tile drainage water [@smith2013reduced] and surface waters due to benthic denitrification [@donner2003evaluating]. However, our approach serves to compare different cropping systems and management on a subfield resolution. We make the simplifying assumption that the reduction of nitrate leaching at 50 cm is proportional to the reduction of nitrate in tile drainage and surface waters. Our framework of cropland area selection and scenario-based land management simulation combines two modeling approaches with assumptions limited by publicly available data. For both the economic estimation and the biogeochemistry model, management practices and crop budgets were assumed to be equal across the state, and only varying with crop rotation [for details on the limitations of the profitability analysis see also @brandes2016subfield]. A preliminary analysis showed that yields of the new switchgrass variety Liberty, chosen as cropping alternative to maize and soybeans due to its high yield potential and cold tolerance, did not linearly respond to cropland quality in multilocation trials (data not shown). Because a sensitivity analysis revealed weak response of the model outcomes to yield variations (figure S5), we argue that yield is not an important factor on a landscape scale when only fractions of existing cropland are converted to perennial vegetation. This argument has to be re-evaluated when better switchgrass yield data become available. DNDC does not account for lateral water flow that is caused by topography and for possible nitrate uptake by roots growing below 50 cm. The latter is likely to occur especially in perennial cropping systems, suggesting that our leaching results for switchgrass are overestimated. Furthermore, the model does not include atmospheric nitrogen deposition, but it is factored out in the comparison between cropping systems. We are not assuming variable rate fertilization, so on some cropland our fertilizer might be over- or underestimated. Also, we do not include manure application due to missing spatial data on amounts and type.


## Conclusions

To our knowledge, this study is the first in estimating water quality impacts covering a large area at a spatial scale relevant for practitioners and decision makers. Our analysis disaggregates previously published approaches of nitrogen balance estimated based on county or watershed data down to a finer resolution and takes into account the biogeochemical processes driving nitrate loss in agroecosystems. The inclusion of perennial crops is particularly promising due to potential synergies between multiple ecosystem functions besides water quality, such as carbon sequestration and erosion control, especially with regards to increasing threats to agricultural systems associated with global warming. 
Nitrate leaching reductions by perennial integration are consistently high relative to the affected land area. The requirement to sacrifice only the least performing fraction of farmland to perennials might compensate for the long-term commitment associated with perennial crops. While cover crops can be planted temporarily, their leaching reduction efficiency has been found to be highly variable, and their management concerns the entire cropland in order to achieve meaningful nitrate leaching reductions.
...
```{r plot_leach_precip, fig.width=9, fig.height=8, fig.cap="Figure S1: Annual nitrate leaching and annual precipitation per county. Each dot represents a county in a given year."}
...
```{r subfield_n_loss_maps, fig.height=5.981, fig.width=4.592, fig.cap="Figure S2: (a) Nitrate leaching and (b) ammonium volatilization modelled with DNDC on a subfield resolution for Iowa. Average values for 2012-2015 are shown."}
