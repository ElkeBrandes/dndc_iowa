...
- Conservative scenario: aiming at profit loss and nitrate leaching mitigation by targeting cropland areas of high economic and environmental risk while keeping the area converted to switchgrass at around 10%
...
```{r scatterplot_no3_leach, fig.width=4.5, fig.height=3, fig.cap="Figure 5: Scatterplot of a subsample (n=10,000) of subfield areas, showing profitability and nitrate (NO~3~^-^) leaching of the baseline scenario (mean values for maize and soybean fields 2012-2015) in Iowa. The red lines indicate the cut off values for the conservative scenario (dashed lines, US$ -100 ha^-1^ for profitability and 50 kg N ha^-1^ for nitrate leaching) and for the nutrient reduction scenario (solid lines,  US$ 0 ha^-1^ for profitability and 20 kg N ha^-1^ for nitrate leaching)."}
ggplot() +
...
kable(no3_leach_table, digits = 2, col.names=c(" ", "Baseline","75,00", "10,000", "12,500"), caption="Table 3: Annual nitrogen loss by nitrate leaching in metric tonnes (Mg) nitrogen and nitrate leaching reduction (%) in Iowa modelled with DNDC. Results are shown for the baseline and the conservative scenario under three different switchgrass yield assumptions (7,500, 10,000, and 12,500 kg ha^-1^)." )
...
Our focus on the Upper North Raccoon River Watershed highlights a relevant issue of nutrient leaching concerning the local scale: Its basin provides municipal drinking water for over 500,000 Iowa residents and its area is dominated by intensively managed agriculture. The capital's uniltiy, the Des Moines Water Works, recently files a lawsuit against the three counties 
The lawsuit was dismissed by the supreme court early this year, but the topic remains highly controversal about liability and regulatory requirements to protect public health.

*(add a sentence or two about the political relevance of the NRRW)*

2.4 % of cropland resulted in very low leaching values that coinsided with ammonia volatilization rates above the state wide average (figure 2 (b)). These areas were clustered in the three western counties Sioux, Plymouth, and Woodbury (figure S2). High volatilization occurs when 
